...
const SidebarLayout: React.FC<SidebarLayoutProps> = ({
  ...
  // Use useOutlet hook to capture the route element. 
  // This ensures the route updates correctly even when passed through conditional rendering,
  // without needing a 'key' prop that would break navigation history/state.
