...
import { LayoutDashboard, BookOpen, Users, Settings, LogOut, X, ShoppingBag } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { signOutUser } from '@/services/authService';

interface AdminSidebarProps {
    activeTab: 'dashboard' | 'courses' | 'users' | 'settings' | 'blog' | 'coupons' | 'store';
    setActiveTab: (tab: 'dashboard' | 'courses' | 'users' | 'settings' | 'blog' | 'coupons' | 'store') => void;
    isOpen?: boolean;
    onClose?: () => void;
}
