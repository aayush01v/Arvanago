    ...
    return (
        ...
        >
            <div
                ...
                className={`bg-white dark:bg-slate-800 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden transition-all duration-300 flex flex-col max-h-[80vh] ${isOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}
            >
                {/* Header */}
                        ...
                        <div className="space-y-1">
                            {users.map(user => (
                                ...
                                >
                                    ...
                                    {/* Placeholder for follow button in list if needed later */}
                                </div>
                            ))}
                        </div>
                    )}
