    ...
    <AnimatePresence>
      {showToast && (
        <motion.div
          ...
          className="fixed top-6 right-6 z-[100] w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl rounded-2xl p-4 flex items-start gap-4"
        >
