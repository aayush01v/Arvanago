...
const AdminStorefront = React.lazy(() => import('../components/admin/AdminStorefront'));
...
const AdminPage: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        switch (activeTab) {
            ...
            case 'store':
                return <React.Suspense fallback={<div>Loading Store Manager...</div>}><AdminStorefront /></React.Suspense>;
            case 'coupons':
